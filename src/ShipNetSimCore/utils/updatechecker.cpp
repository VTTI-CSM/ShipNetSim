...
{
    QUrl url(
        "https://api.github.com/repos/VTTI-CSM/ShipNetSim/releases");
...
void UpdateChecker::replyFinished(QNetworkReply *reply)
{
    ...
    for (const QJsonValue &value : releases)
    {
        ...
        QDateTime publishedDate = QDateTime::fromString(
            releaseObj.value("published_at").toString(), Qt::ISODate);
