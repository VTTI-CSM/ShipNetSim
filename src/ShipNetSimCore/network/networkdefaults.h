...
static const QVector<QString> &
SalinityTiffLocations(QString baseDirectory)
{
    static QVector<QString> v{
...
static const QVector<QString> &
WaveHeightTiffLocations(QString baseDirectory)
{
    static QVector<QString> v{
...
static const QVector<QString> &
wavePeriodTiffLocations(QString baseDirectory)
{
    static QVector<QString> v{
...
static const QVector<QString> &
waterDepthTiffLocations(QString baseDirectory)
{
    static QVector<QString> v{
...
static const QVector<QString> &
seaPortsLocations(QString baseDirectory)
{
    static QVector<QString> v{
