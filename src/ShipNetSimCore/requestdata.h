...
template <typename T> struct RequestData
{
    /**
    ...
    /**
     * @brief Thread-safe method to retrieve data for a specific
     * network.
     * @param network The network identifier.
    ...
    T getData(const QString &network) const
    {
        ...
        return dataBuffer.value(
            network); // Returns default-constructed T
                      // if not found
    }

    /**
     * @brief Thread-safe method to get the list of keys (network
     * identifiers) in the dataBuffer.
    ...
    /**
     * @brief Thread-safe method to increment the completed requests
     * counter.
     */
    ...
    /**
     * @brief Thread-safe method to get the current count of completed
     * requests.
    ...
    /**
     * @brief Thread-safe method to reset the completed requests
     * counter.
     */
    ...
    /**
     * @brief Thread-safe method to set the list of requested
     * networks.
    ...
    /**
     * @brief Thread-safe method to add a network to the requested
     * network list.
     * @param network The network identifier.
     */
    ...
    /**
     * @brief Thread-safe method to get the list of requested
     * networks.
    ...
    /**
     * @brief Thread-safe method to clear the list of requested
     * networks.
     */
...
private:
    QMap<QString, T>
        dataBuffer; ///< Stores operation results for each network
    int completedRequests =
        0; ///< Counter for completed network operations
    QVector<QString>
        requestedNetworkProcess; ///< List of networks involved
    mutable QMutex
        mutex; ///< Mutex to protect access to the data members
};
